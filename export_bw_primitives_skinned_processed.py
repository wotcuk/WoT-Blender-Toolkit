...
class BigWorldModelExporterSkinnedProcessed:
                    ...
                    if poly.material_index == mat_id:
                        ...
                        for vidx, i in enumerate(loop):
                            ...
                            if len(vert.groups) == 1:
                                ...
                                weight1 = vert.groups[2].weight
                                weight2 = vert.groups[1].weight
                                weight3 = vert.groups[0].weight
                            ...
                            IIIWW = (index1, index2, index3, 0, 0, 0, weight1, weight2)
                            XYZNUVIIIWWTB += IIIWW
    ...
    def export(self, object_list: list, model_filepath: str, export_info: dict):
        ...
        vertices_subname = b'BPVTxyznuviiiwwtb'
        vertices_format = b'set3/xyznuviiiwwtbpc'
        vertices_secsize = 40
        vertices_pcformat = '<3fI2f8B2I'
        ...
        with open(primitives_filepath, 'wb') as f:
            ...
            for render_set in render_sets:
                ...
                vertices_section_size = render_set['geometry']['primitiveGroups']['nVertices']*vertices_secsize + 136
